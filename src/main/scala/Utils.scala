      ...
      .flatMap {
        ...
        case simplex if simplex.vertices.size == 2 =>
          ...
          for
            ...
            pos1 = positions(a)
            pos2 = positions(b)
          yield s"""<line x1="${pos1(0)}" y1="${pos1(1)}" x2="${pos2(0)}" y2="${pos2(1)}" stroke="black" stroke-width="1"/>"""
        ...
        case simplex if simplex.vertices.size == 3 =>
          ...
          yield
            ...
            s"""<polygon points="${pos1(0)},${pos1(1)} ${pos2(0)},${pos2(1)} ${pos3(0)},${pos3(
                1
              )}" fill="blue" fill-opacity="0.25" stroke="none"/>"""
