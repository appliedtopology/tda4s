...
The `TDA4s` library implements persistent homology and related techniques from computational and applied topology, in a library designed for ease of use, ease of access from Matlab and java-based systems, and ease of extensions for further research projects and approaches.
...
On this site we include a fully compiled @scaladoc[ScalaDoc](org.appliedtopology.tda4s) documentation.